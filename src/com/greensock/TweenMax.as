...
package com.greensock 
{
	...
	public class TweenMax extends TweenLite implements IEventDispatcher 
	{
		...
		TweenPlugin.activate( [
			...
			//ACTIVATE (OR DEACTIVATE) PLUGINS HERE... AutoAlphaPlugin,			//tweens alpha and then toggles "visible" to false if/when alpha is zero EndArrayPlugin,				//tweens numbers in an Array
