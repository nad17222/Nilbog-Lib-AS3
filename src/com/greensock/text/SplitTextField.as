...
while (i--) {
	...
	TweenMax.to(stf2.textFields[i], 2, {physics2D:{angle:angle, velocity:RNG.random() ~~ 200 + 150, gravity:400}, scaleX:RNG.random() ~~ 4 - 2, scaleY:RNG.random() ~~ 4 - 2, rotation:RNG.random() ~~ 100 - 50, autoAlpha:0, delay:1 + RNG.random()});
}
