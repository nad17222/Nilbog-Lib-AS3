    ...
    public class Boid extends Sprite
    {
        ...
        public function Boid( className:String = null ) 
        {
            if (className == null)
            {
                ...
                {
                    fail( "A class name is required for Boids if you aren't " + "subclassing Boid." );
                }
            }
            else
            {
        ...
        private function initializeWithClassName( className:String ):void
        {
            ...
            addChild( animation );
            animation.gotoAndPlay( 1 + Math.floor( RNG.random( ) * animation.totalFrames ) );
        }
        ...
        {
            var a:Number = .3;
            xvelocity += a * (RNG.random( ) - RNG.random( ));
            yvelocity += a * (RNG.random( ) - RNG.random( ));
