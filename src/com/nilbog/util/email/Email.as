package com.nilbog.util.email 
{
	 ...
	 * 
	 * @eventType com.nilbog.util.email.EmailEvent.SUCCESS
	 */
	[Event(name="emailSuccess", type="com.nilbog.util.email.EmailEvent")]

	/**
	 * Dispatched when a server-side script that sends email returns success.
	 * 
	 * @eventType com.nilbog.util.email.EmailEvent.FAILURE
	 */
	[Event(name="emailFailure", type="com.nilbog.util.email.EmailEvent")]
